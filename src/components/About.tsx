            ...
            >
              <div className="space-y-4">
                <p className="text-gray-600 leading-relaxed text-lg">
                  ...
                  compassion, and a vision to make quality healthcare accessible
                  to everyone.
                </p>

                <p className="text-gray-600 leading-relaxed text-lg">
                  What began humbly in a single flat with just a few patients
                  and minimal equipment has grown into a magnificent
                  three-storey medical facility — a symbol of dedication,
                  resilience, and divine favour. Today, the hospital stands as a
                  beacon of hope and a household name in the region, where
                  healing truly meets grace.
                </p>
              </div>
            </AnimatedContent>
