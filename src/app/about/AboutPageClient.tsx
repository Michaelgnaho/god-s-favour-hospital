        ...
        <div className="max-w-7xl mx-auto">
              ...
              >
                <div className="space-y-6">
                  <p className="text-gray-600 leading-relaxed text-lg">
                    ...
                    passionate healthcare professionals driven by faith,
                    compassion, and a vision to make quality healthcare
                    accessible to everyone.
                  </p>

                  <p className="text-gray-600 leading-relaxed text-lg">
                    What began humbly in a single flat with only a few patients
                    and minimal equipment has now grown into a magnificent
                    three-storey medical facility, symbolizing years of
                    dedication, resilience, and divine favor.
                  </p>
                </div>
              </AnimatedContent>
          ...
          >
            <div className="space-y-8 max-w-4xl mx-auto mb-20">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Over the years, the hospital has flourished, now home to a
                growing team of 7 dedicated staff and over 20 qualified nurses,
                all united by a shared mission of healing and service. The
                hospital&apos;s story is not just one of physical expansion but
                also of community transformation.
              </p>

              <p className="text-gray-600 leading-relaxed text-lg">
                Today, God&apos;s Favourite Hospital stands not just as a
                healthcare center but as a beacon of hope and a household name
                in the region — a living testament that with faith, hard work,
                and love for humanity, greatness is inevitable. The name
              ...
              {milestones.map((milestone, index) => {
                ...
                return (
                  <AnimatedContent
                    ...
                    threshold={0.2}
                  >
                    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 text-center hover:shadow-xl transition-shadow duration-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg border-l-4 border-blue-600">
                ...
                <p className="text-gray-600 leading-relaxed text-lg mb-4">
                  We aspire to build a healthcare model that sets the standard
                  for quality, compassion, and accessibility — one that reaches
                  beyond hospital walls to uplift the community through
                  education, outreach, and preventive health programs.
                </p>
